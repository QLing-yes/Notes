...
> contain: ; [链接](https://developer.mozilla.org/zh-CN/docs/Web/CSS/contain)
...
```javascript
let o = new IntersectionObserver(callback, option);
o.observe(<element>);// 开始观察
o.unobserve(<element>);// 停止观察
o.disconnect();// 关闭观察器
```
