...
### [shadow](https://developer.mozilla.org/zh-CN/docs/Web/Web_Components/Using_shadow_DOM#%E5%9F%BA%E6%9C%AC%E7%94%A8%E6%B3%95)

- 独立的 DOM 附加(**隔离**)到一个元素上
- Shadown DOM 和操作普通DOM是一样的
